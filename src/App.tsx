...
function ChatInterface({ user, staffUser }: { user: any; staffUser: StaffUser | null }) {
  ...
  const toggleNotifications = async () => {
    ...
    if (granted) {
      new Notification('Staff by Nexa', {
    ...
    <div className="flex flex-col h-[calc(100vh-80px)]">
      ...
      <div className="glass-card m-4 p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-white">Staff by Nexa</h2>
    ...
    <header className="fixed top-0 left-0 w-full z-50 glass-card !rounded-none border-b border-t-0 border-x-0">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        <a href="#" className="text-2xl font-black text-white flex items-center gap-2">
          <SmartBotIcon />
          <span>Staff<span className="text-purple-400"> by Nexa</span></span>
        </a>
    ...
    <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 z-10">
        <div className="inline-block bg-purple-500/20 text-purple-300 text-sm font-bold px-4 py-2 rounded-full mb-6 border border-purple-500/30">
          Staff Premium incluído para clientes Nexa
        </div>

        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-gray-100 leading-tight mb-6">
          Seu assistente pessoal<br />
          dentro da <span className="text-purple-400">Nexa</span>
        </h1>

        <p className="text-lg md:text-xl lg:text-2xl text-slate-400 mb-10 max-w-3xl mx-auto">
          O Staff é o assistente inteligente do ecossistema Nexa para organizar rotina, finanças, família, saúde, trabalho e produtividade em um só lugar.
        </p>
  ...
  return (
    <section id="signup" className="py-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-100 mb-4">
            Incluído para clientes Nexa
          </h2>
          <p className="text-lg md:text-xl text-slate-400">
            Seu assistente pessoal inteligente como benefício do ecossistema Nexa.
          </p>
        </div>
        ...
        <div className="glass-card p-8 md:p-12 max-w-2xl mx-auto text-center border-2 border-green-500 glow-effect-purple">
          ...
          <h3 className="text-2xl md:text-3xl font-bold text-gray-100 mb-4">Staff Premium</h3>

          <div className="flex items-baseline justify-center gap-2 mb-6">
            <span className="text-5xl md:text-6xl font-black text-green-400">NEXA</span>
          </div>
          ...
          <ul className="text-left text-slate-300 space-y-3 mb-8 max-w-md mx-auto">
            ...
            <li className="flex items-center gap-3">
              <CheckCircle className="text-green-400 w-5 h-5 flex-shrink-0" />
              <span>Incluído para usuários Nexa</span>
            </li>
          </ul>
    ...
    <section id="faq" className="py-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-slate-400">
            Tire suas dúvidas sobre o Staff by Nexa
          </p>
        </div>
    ...
    <section className="py-24">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-100 mb-6">
          Seu Staff pessoal, dentro do ecossistema Nexa.
        </h2>
        <p className="text-lg md:text-xl text-slate-300 mb-10 max-w-2xl mx-auto">
          Acesse seu assistente inteligente para organizar rotina, finanças, saúde, trabalho e produtividade com a experiência Nexa.
        </p>
        <button
          onClick={onLoginClick}
  ...
  return (
    <footer className="py-12 border-t border-slate-800">
      <div className="container mx-auto px-6 text-center text-slate-400">
        ...
        <p>&copy; 2026 Staff by Nexa — assistente pessoal inteligente para clientes Nexa.</p>
      </div>
    </footer>
  )
}
  ...
  return (
    <>
      <div className="text-center mb-6">
        ...
        <p className="text-slate-400 text-sm mt-2">Acesse sua conta Staff by Nexa</p>
      </div>
  ...
  return (
    <>
      <div className="text-center mb-6">
        ...
        <p className="text-slate-400 text-sm mt-2">Crie seu acesso ao Staff by Nexa</p>
      </div>
